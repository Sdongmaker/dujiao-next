...
const siteUrl = ref('')
const siteName = ref('')
const brandLabel = computed(() => siteName.value || t('admin.layout.brandFallback'))
const brandInitial = computed(() => (brandLabel.value.trim().charAt(0) || 'A').toUpperCase())
    ...
    <div class="flex min-h-screen">
      ...
      >
        <div class="py-6" :class="sidebarCollapsed ? 'px-2' : 'px-6'">
          ...
          <div v-if="sidebarCollapsed" class="text-lg font-semibold tracking-tight text-center">{{ brandInitial }}</div>
        </div>
