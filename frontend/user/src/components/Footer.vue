<template>
  <footer
    ...
    <div class="container mx-auto px-4 py-16 relative">
      ...
      <!-- Copyright -->
      <div
        class="border-t pt-8 flex flex-col md:flex-row items-center justify-end gap-4 text-xs text-muted-foreground">
...
const brandSiteName = computed(() => {
  ...
  return typeof siteName === 'string' && siteName.trim() ? siteName.trim() : fallbackBrandName()
})
